...
with app.app_context():
    ...
    print(f'   Expenses : {total} entries across Jan–May 2026')
    ...
    print(f'   Apr ≈ ₹63,486  |  May ≈ ₹57,476 (partial)')
